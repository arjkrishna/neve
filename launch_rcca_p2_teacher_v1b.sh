...
# Monitor:  docker logs -f rcca_p2_teacher_v1b  |  Stop: docker stop -t 60 rcca_p2_teacher_v1b
set -e
export MSYS_NO_PATHCONV=1

docker rm rcca_p2_teacher_v1b 2>/dev/null || true

docker run --name rcca_p2_teacher_v1b --gpus all --shm-size=30g --init -d \

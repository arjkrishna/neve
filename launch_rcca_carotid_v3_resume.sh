...
#
# Monitor:  docker logs -f rcca_carotid_v3  |  Stop: docker stop -t 60 rcca_carotid_v3
set -e
export MSYS_NO_PATHCONV=1

docker rm rcca_carotid_v3 2>/dev/null || true

docker run --name rcca_carotid_v3 --gpus all --shm-size=30g --init -d \
  ...
  python3 /opt/eve_training/training_scripts/DualDeviceNav_train.py \
    --env_version 5 \
    -n rcca_carotid_v3 \
    --resume /opt/eve_training/results/eve_paper/neurovascular/full/mesh_ben/2026-09-08_220413_rcca_carotid_v3 \
    --topbrain \

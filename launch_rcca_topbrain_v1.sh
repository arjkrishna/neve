...
#
# Monitor:  docker logs -f rcca_topbrain_v1  |  Stop: docker stop -t 60 rcca_topbrain_v1
set -e
export MSYS_NO_PATHCONV=1

docker rm rcca_topbrain_v1 2>/dev/null || true

docker run --name rcca_topbrain_v1 --gpus all --shm-size=30g --init -d \
  ...
  python3 /opt/eve_training/training_scripts/DualDeviceNav_train.py \
    ...
    --topbrain_exclude topcow_mr_013 topcow_mr_014 topcow_mr_015 topcow_mr_025 \
    --topbrain_holdout topcow_mr_007 topcow_mr_008 topcow_mr_017 topcow_mr_022 \

"""
function_check.py without visualization.

This version removes the SofaPygame visualization to test if visualization
is causing any issues during RL training.
"""
import csv
import os
...
def make_env() -> eve.Env:
    ...
    # VISUALIZATION REMOVED - This is the ONLY change!
    ...
    env = eve.Env(
        ...
        visualisation=None,  # Changed from SofaPygame to None
        start=start,
        pathfinder=pathfinder,
    )
    return env

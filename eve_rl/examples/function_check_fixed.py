...
def sac_training(
    ...
    try:
        ...
        print("Training complete! Closing environment properly...")
        # CRITICAL FIX: Close the environment BEFORE the function returns
        # This prevents segmentation faults when SOFA tries to clean up
        env.close()

#!/bin/bash
# Phase C grid smoke test — 5 checkpoints x 9 variants = 45 episodes
# Tests grid runner end-to-end before committing to full 173x9 run.
set -e
export MSYS_NO_PATHCONV=1

CKPT_DIR="/opt/eve_training/results/eve_paper/neurovascular/full/mesh_ben/2026-05-06_224638_env5_rl8_RVA_v2cfg_500ep_inst/diagnostics/rva_checkpoints"

docker rm env5_rl8_phase_c_smoke 2>/dev/null || true

docker run --name env5_rl8_phase_c_smoke --gpus all --shm-size=24g --init -d \

...
#
# Monitor:  docker logs -f rcca_topbrain_v2  |  Stop: docker stop -t 60 rcca_topbrain_v2
set -e
export MSYS_NO_PATHCONV=1

docker rm rcca_topbrain_v2 2>/dev/null || true

docker run --name rcca_topbrain_v2 --gpus all --shm-size=30g --init -d \
  ...
  python3 /opt/eve_training/training_scripts/DualDeviceNav_train.py \
    ...
    -n rcca_topbrain_v2 \
    --topbrain \
    --topbrain_dir /opt/eve_training/topbrain_data/anatomies_v2 \
    --topbrain_seed 12345 \

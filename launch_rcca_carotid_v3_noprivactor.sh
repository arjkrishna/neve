...
#
# Monitor:  docker logs -f rcca_carotid_v3_noprivactor  |  Stop: docker stop -t 60 rcca_carotid_v3_noprivactor
set -e
export MSYS_NO_PATHCONV=1

docker rm rcca_carotid_v3_noprivactor 2>/dev/null || true

docker run --name rcca_carotid_v3_noprivactor --gpus all --shm-size=30g --init -d \
